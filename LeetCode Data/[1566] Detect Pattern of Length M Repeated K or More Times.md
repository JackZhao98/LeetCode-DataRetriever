...
[![Array_badge](https://img.shields.io/badge/topic-Array-green.svg)](https://leetcode.com/problems/detect-pattern-of-length-m-repeated-k-or-more-times/) 
...
- Language: python3
- Runtime: 40 ms
- Completed time: 2020-08-29 21:05:16
...
class Solution:
    def containsPattern(self, arr: List[int], m: int, k: int) -> bool:
        i = 0
        counter = 0
        while i + m <= len(arr) and counter < k:
            counter = 1
            pattern = arr[i:i+m]
            j = i + m
            while j + m <= len(arr):
...
Among **22570** total submissions, **9458** are accepted, with an acceptance rate of **41.9%**. <br>
